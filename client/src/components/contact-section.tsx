...
const socialLinks = [
  {
    icon: Linkedin,
    url: "https://www.linkedin.com/in/md-kashif-9426b4357",
    label: "LinkedIn"
  },
  {
    icon: Github,
    url: "https://github.com/MdKashif05",
    label: "GitHub"
  },
  {
    icon: Mail,
    url: "mailto:mdkashif3300@gmail.com",
    label: "Email"
  },
  {
    icon: Phone,
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <Input
                    ...
                    required
                    className="glass border-glass-border bg-glass-bg text-white placeholder:text-gray-400 focus:border-cyan-500"
                  />
                  <Input
                    name="email"
                    type="email"
                ...
                <Textarea
                  ...
                  onChange={handleInputChange}
                  required
                  className="glass border-glass-border bg-glass-bg text-white placeholder:text-gray-400 focus:border-cyan-500 resize-none"
                />
            ...
            <div className="space-y-6">
              <div className="glass rounded-2xl p-6">
                <h4 className="text-xl font-bold text-blue-500 mb-4 flex items-center">
                ...
                <div className="space-y-3">
                  <p className="flex items-center">
                    ...
                    <a href="mailto:mdkashif3300@gmail.com" className="text-white hover:text-blue-500 transition-colors">
                      mdkashif3300@gmail.com
                    </a>
                  </p>
                  <p className="flex items-center">
                    <Phone className="mr-3 h-4 w-4 text-emerald-400" />
                    <a href="tel:7033758217" className="text-white hover:text-blue-500 transition-colors">
                      +91 7033758217
                    </a>
                  </p>
                  <p className="flex items-center">
